...
import College from "/public/images/VIT.svg";
import Avalon from "/public/images/Avalon.svg";
    ...
    <div className="flex flex-col gap-4 px-6 pt-24 md:pt-32 ">
      ...
      <div className="grid auto-cols-max grid-cols-1 gap-3 pt-4 md:grid-cols-2 md:grid-rows-2 md:gap-4 md:pt-8">
        ...
        <CurrentlyCard
          ...
          //   </svg>
          // }
          icon={<Image src={Avalon} width={24} height={24} alt="netflix" />}
          heading="Looking for opportunities"
          subHeading="Freelance/ Internships"
          image={Avalon}
        />{" "}
        <CurrentlyCard
          icon={
